...
class App extends Component {
  ...
  render() {
    return (
      <div>
        <SiteHeader score={this.state.score} high_score={this.state.high_score} color_switch={this.state.color_switch} />
        <Wrapper>
          <div id='main_bkg' style={{background:`url(./images/main_bkg.jpg`}}/>
          <HeroBanner />
          <ul className={`list-inline heroes-group col-sm-12 ${this.state.anim_class}`}>
